...
public class CustomerRegistrationStepOne extends AppCompatActivity {
    @BindView(R.id.next)
    Button button;
    ...
    String cont_number, reg_no, c_name, c_state, c_city, cust_email, Cust_id, dealer_id;
                    ...
                    if (model.responce == 1) {
                        ...
                        if (model.data.size() > 0) {
                            ...
                            for (int i = 0; i < model.data.size(); i++) {
                                ...
                                Intent intent = new Intent(CustomerRegistrationStepOne.this, CustomerRegStepTwo.class);
    ...
    private void logout() {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i = new Intent(CustomerRegistrationStepOne.this, SplashScreenActivity.class);
