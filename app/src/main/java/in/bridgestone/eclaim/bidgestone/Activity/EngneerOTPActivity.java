...
public class EngneerOTPActivity extends AppCompatActivity {
    @BindView(R.id.next)
    Button button;
    ...
    public void submit(View view){
        ...
        if (Motp.equals(OTP)){
            ...
            Intent intent=new Intent(EngneerOTPActivity.this,EngineerInfoActivity.class);
            startActivity(intent);
        }else {
            Toast.makeText(EngneerOTPActivity.this, "Wrong OTP", Toast.LENGTH_SHORT).show();
