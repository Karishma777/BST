...
public class PhotosActivity extends AppCompatActivity {
    ...
    String e_claim_id;
    String cust_id, vehical_id, complaint_id, dealer_id;
    ...
    private void Addeclaim() {
        ...
        Call<AddEclaimApi> call3 = apiInterface.add_e_claim(cust_id, dealer_id, complaint_id, vehical_id);
                    ...
                    case 200:
                        ...
                        if (jsonObject != null) {
                            ...
                            if (array.size() != 0) {
                                ...
                                Toast.makeText(PhotosActivity.this, "Claim Successfully Added", Toast.LENGTH_SHORT).show();
                                finish();
                                Intent loginIntent = new Intent(PhotosActivity.this, PDFActivity.class);
                            ...
                            MyUtility.showAlertMessage(PhotosActivity.this, MyUtility.FAILED_TO_GET_DATA);
                        }
    ...
    private void selectImage(final int number) {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                boolean result = Utility.checkPermission(PhotosActivity.this);
    ...
    public void Back(View view) {
        Intent intent = new Intent(PhotosActivity.this, CustomerComplaint.class);
