...
public class CustRegNoAdapter extends ArrayAdapter implements Filterable {
    private ArrayList<CustomerInfoModel> mInfraList;
    private Context context;

    public CustRegNoAdapter(Context context, int resource) {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint != null){
                    try{
                        ...
                        Call<Search_cust_by_reg_numberApi> call3 = apiInterface.search_and_get_customer_by_reg_no(term);
                                    ...
                                    if (model.responce == 1) {
                                        ...
                                        if (model.data.size() > 0) {
                                            ...
                                            for (int i = 0; i < model.data.size(); i++) {
                                                ...
                                                model1.setCustomer_reg_no(model.data.get(i).customer_reg_no);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        countryName.setText(contry.getCustomer_reg_no());
