...
public class DamageDetailsAdapter extends ArrayAdapter implements Filterable {
    private ArrayList<ComplaintModel> mInfraList;
    private Context context;

    public DamageDetailsAdapter(Context context, int resource) {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint != null){
                    try{
                        ...
                        Call<ComplaintApi> call3 = apiInterface.get_damage_details(term);
