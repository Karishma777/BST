...
public class VehicalMakeAdapter extends ArrayAdapter implements Filterable {
    private ArrayList<VehicalMakeModel> mInfraList;
    private Context context;

    public VehicalMakeAdapter(Context context, int resource) {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint != null){
                    try{
                        ...
                        Call<VehicalMakeApi> call3 = apiInterface.get_vehicle_make(term);
                        call3.enqueue(new Callback<VehicalMakeApi>() {
                            ...
                            public void onResponse(Call<VehicalMakeApi> call, Response<VehicalMakeApi> response) {
                                ...
                                Log.e("VehicalMake:", new Gson().toJson(response.body()));
                                    ...
                                    if (model.responce == 1) {
                                        ...
                                        if (model.data.size() > 0) {
                                            ...
                                            for (int i = 0; i < model.data.size(); i++) {
                                                ...
                                                model1.setMake_name(model.data.get(i).make_name);
                                                model1.setMake_and_model_id(model.data.get(i).make_and_model_id);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        countryName.setText(contry.getMake_name());
        String make_id=contry.getMake_and_model_id();
