...
public class VehicalRegNoAdapter extends ArrayAdapter implements Filterable {
    private ArrayList<CustomerInfoModel> mInfraList;
    private Context context;

    public VehicalRegNoAdapter(Context context, int resource) {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint != null){
                    try{
                        ...
                        Call<Search_cust_by_reg_numberApi> call3 = apiInterface.get_customer_address(term);
